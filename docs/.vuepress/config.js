...
module.exports = {
  ...
  themeConfig: {
    ...
    logo: 'https://i.postimg.cc/2yr3430s/panda.jpg', // 导航栏logo  img/gif/panda.jpg
    repo: 'user-h/hdata-doc', // 导航栏右侧生成Github链接
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, href: String}
      name: 'Ai', // 必需
      href: 'https://github.com/user-h' // 可选的
    },
    ...
    footer: { // 页脚信息
      ...
      copyrightInfo: 'Ai | MIT License', // 博客版权信息，支持a标签
    },
    htmlModules,
  },
  ...
  plugins: [
    ...
    ['vuepress-plugin-mermaidjs'],  // 支持mermaid语法
