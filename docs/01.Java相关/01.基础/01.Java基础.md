...
<code-group>
  ...
  public class T_Method {
  	public static void main(String []args){
  		...
  		System.out.println(s.replace("AbCdefgHijk_LmnopwrStuVwxyz", "ahb"));
  ...
  public class Test {
  	public static void main(String[] args) {
  		...
  		Student s1 = new Student("ahb", (byte) 20, "17044201");
  		Student s2 = new Student("bbb", (byte) 23, "17044233");
  		Student s3 = new Student("ccc", (byte) 21, "17044266");
  		Student s4 = new Student("ahb", (byte) 19, "17044299");
  		hs.add(s1);
  		hs.add(s2);
  		hs.add(s3);
  		hs.add(s4);
  		...
  		Students s5 = new Students("ahb", (byte) 20, "17044201");
  		Students s6 = new Students("bbb", (byte) 23, "17044233");
  		Students s7 = new Students("ccc", (byte) 21, "17044266");
  		Students s8 = new Students("ahb", (byte) 19, "17044299");
  		hst.add(s5);
  		hst.add(s6);
  		hst.add(s7);
  		hst.add(s8);
  ...
  public class T_map {
  	public static void main(String[] args) {
  		...
  		if (map.containsKey("ahb") && map.get("ahb").equals("987654321")) {
  ...
  public class T_Collections {
  	public static void main(String[] args) {
  		...
  		stu[0] = new Student("aaa",(byte)20,"17044201");
  		stu[1] = new Student("bbb",(byte)19,"17040001");
  		stu[2] = new Student("ccc",(byte)21,"17040002");
  		...
  		Student s = new Student("ccc",(byte)21,"17040002");		//为什么先反转有两个查不到？？？
