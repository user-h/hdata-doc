...
mvn install:install-file -Dfile=./pentaho-aggdesigner-algorithm-5.1.5-jhyde-sources.jar -DgroupId=org.pentaho -DartifactId=pentaho-aggdesigner-algorithm -Dversion=5.1.5-jhyde -Dpackaging=jar
